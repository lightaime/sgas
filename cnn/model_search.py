...
class Network(nn.Module):
    ...
    def __init__(self, C, num_classes, layers, criterion, steps=4, multiplier=4, stem_multiplier=3, in_channel=3):
        ...
        self.stem = nn.Sequential(
            nn.Conv2d(in_channel, C_curr, 3, padding=1, bias=False),
